...
def sierpinski(degree, p1, p2, p3, color, line_width, screen):
    ...
    if(degree>0):
        ...
        sierpinski(degree-1,find_midpoint(p1,p2),p2,find_midpoint(p2,p3),color,line_width,screen)
        sierpinski(degree-1,find_midpoint(p1,p3),find_midpoint(p3,p2),p3,color,line_width,screen)
